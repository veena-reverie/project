...
temp_exprsn_eng={'today':[0,'days'],'today\'s':[0,'days'],'tomorrow':[1,'days'],'tomorrow\'s':[1,'days'],'yesterday':[-1,'days'],'yesterday\'s':[-1,'days'],'day after tomorrow':[2,'days'],'next week':[7,'days'],'last week':[-7,'days'],'sunday':[SU,'weeks'],'monday':[MO,'weeks'],'tuesday':[TU,'weeks'],'wednesday':[WE,'weeks'],'thursday':[TH,'weeks'],'friday':[FR,'weeks'],'saturday':[SA,'weeks']}
#lang other than english dictionary is made with revcode

temp_exprsn_hin={'Aja':[0,'days'],'kala':[1,'days'],'bitA kala':[-1,'days'],'parasOx':[2,'days'],'agalE saptAha':[7,'days'],'piCalE saptAha':[-7,'days'],'ravivAra':[SU,'weeks'],'sOmavAra':[MO,'weeks'],'mxgalavAra':[TU,'weeks'],'buHdavAra':[WE,'weeks'],'gurUvAra':[TH,'weeks'],'SukravAra':[FR,'weeks'],'SanivAra':[SA,'weeks']}
temp_exprsn_tel={'nEDu':[0,'days'],'I rOju':[0,'days'],'TuDE':[0,'days'],'TuDEs':[0,'days'],'rEpaTi':[1,'days'],'rEpu':[1,'days'],'TumArO':[1,'days'],'ninna':[-1,'days'],'ninnaTi rOju':[-1,'days'],'esTar DE':[-1,'days'],'elluxDi':[2,'days'],'rEpu tarvAta rOju':[2,'days'],'DE APTar TumArO':[2,'days'],'gaDicina vArx':[-7,'days'],'lAsT vIk':[-7,'days'],'vaccE vArx':[7,'days'],'neksT vIk':[7,'days'],'tadupari vArx':[7,'days'],'gata vArx':[-7,'days'],'AdivArx':[SU,'weeks'],'sOmavArx':[MO,'weeks'],'mxgaLavArx':[TU,'weeks'],'buHdavArx':[WE,'weeks'],'guruvArx':[TH,'weeks'],'SukravArx':[FR,'weeks'],'SanivArx':[SA,'weeks'],
                 'AdivArAniki':[SU,'weeks'],'sOmavArAniki':[MO,'weeks'],'mxgaLavArAniki':[TU,'weeks'],'buHdavArAniki':[WE,'weeks'],'guruvArAniki':[TH,'weeks'],'SukravArAniki':[FR,'weeks'],'SanivArAniki':[SA,'weeks'],'sxDE':[SU,'weeks'],'mxDE':[MO,'weeks'],'TyUs DE':[TU,'weeks'],'veDnes DE':[WE,'weeks'],'Htars DE':[TH,'weeks'],'PrYE DE':[FR,'weeks'],'sATar DE':[SA,'weeks']}
#for identifying next and last
weeks_dict={'english':{'next':+1,'last':-1},'hindi':{'agalE':+1,'piCalE':-1},'telugu':{'tadupari':+1,'gata':-1,'civari':-1,'vaccE':+1,'lAsT':-1,'neksT':+1}}
